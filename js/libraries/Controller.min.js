...
/*! Controller.min.js - v1.0.0 - 2016-08-30 */
function Controller(b) {
  ...
  function c() {
    ...
    var b = {};if ("standard" === N.mapping ? (L = !1, b = this.constructor.layouts.get("standard")) : this.constructor.layouts.has(this.name) ? (L = !1, b = this.constructor.layouts.get(this.name)) : (console.warn(a.MAP), b = this.constructor.layouts.get("_unknown")), l(b), L) return b;var c = y();c && c in b && (b = b[c]);for (var _d in b.axes) {
  ...
  var b = a && a.interval || 500,
    ...
    if (void 0 !== c && this.controllerCount >= c) return void clearInterval(this.interval);for (var _b8 in this.gamepads) {
      if (_b8 = parseInt(_b8, 10), isNaN(_b8)) return;if (void 0 !== this.gamepads[_b8] && void 0 === this.getController(_b8)) {
